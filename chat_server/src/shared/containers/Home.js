		...
		return (
            <div style={styles.fillSpace}>
				...
				{ this.props.redux.user.login &&	
					<div style={styles.phoneWrapOuter}>
						<img src="/images/iphone-overlay.png" style={styles.phoneImage} />
						<div style={styles.phoneWrapInner}>
							<p style={styles.phoneTime}>
								{
									...
									<span>{`0${this.state.time.getMinutes()}`}</span> :
						...
						<div id="chat_wrap" style={styles.chatWrap}>
						...
						<i id="scroll_to_bottom"
							onClick={ this.scrollChatWindowToBottom }
